...
<div class="wrapper">
    ...
    <div class="content-wrapper center">
        ...
        <section class="content-header">
            <h1> This is a {{ $statusCode }} error.</h1>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <!-- /.box-header -->
                        <div class="box-body ">
                            <h3>Sorry, can't find what you are looking for!</h3>
                            <p class="lead text-muted">Yeah! I know this is awkward.</p>

                            <h4>Return</h4>
                            <p><a href="{{ route('admin.home') }}" class="btn btn-primary">Return to Admin Dashboard</a> </p>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
