...
@section('content')
    ...
    <div class="clearfix">
        ...
        <p>We’re still passionate about recycling unwanted goods, upcycling and re-use. And we’re here to help you sell no-longer-needed belongings, or find the perfect item at an amazing price. Our aim is to provide a great customer experience and deliver what we call the Friday Feeling!</p>
        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit?</p>
        <p>Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. Aliquam erat volutpat. Nam dui mi, tincidunt quis, accumsan porttitor, facilisis luctus, metus.</p>
        <p>To submit a question or comment regarding advertising with the Friday-Ad, please email support@friday-ad.co.uk</p>
        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit?</p>
        <p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p>
        <p>Send us your ideas on how we might improve our service or to tell us what you think of our current service to support@friday-ad.co.uk</p>
        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit?</p>
